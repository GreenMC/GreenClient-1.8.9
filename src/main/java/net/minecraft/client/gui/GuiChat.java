...
public class GuiChat extends GuiScreen {
    ...
    private void sendAutocompleteRequest(String inputTillCursor, String fullInput) {
        if (inputTillCursor.length() >= 1) {
            ...
            this.mc.thePlayer.sendQueue.addToSendQueue(new C14PacketTabComplete(inputTillCursor, blockpos));
    ...
    public void onAutocompleteResponse(String[] playerNames) {
        if (this.waitingOnAutocomplete) {
            ...
            String s2 = StringUtils.getCommonPrefix(playerNames);
